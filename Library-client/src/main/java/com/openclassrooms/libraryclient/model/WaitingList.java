...
public class WaitingList {
    ...
    public WaitingList(Long id, Integer size, boolean full, String documentTitle, LocalDate endDateNextLoanReturn, int numberUsersInWaitingList, Long documentId) {
        this.id = id;
        this.size = size;
        this.full = full;
